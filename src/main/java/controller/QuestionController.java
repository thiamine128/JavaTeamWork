...
public class QuestionController implements Initializable {
    ...
    private void resetQuestionImage(){
        ...
        UIAnimation.fadeAnimation(provinceName, event -> {
            ans0.setImage(new Image(getClass().getResourceAsStream(details[thisQuestion - 1].path.get(0))));
            ans1.setImage(new Image(getClass().getResourceAsStream(details[thisQuestion - 1].path.get(1))));
            ans2.setImage(new Image(getClass().getResourceAsStream(details[thisQuestion - 1].path.get(2))));
            ans3.setImage(new Image(getClass().getResourceAsStream(details[thisQuestion - 1].path.get(3))));
